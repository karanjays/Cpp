//1.Create an array to store the student information (ex. Student code,
//Name, Address, Mobile, Total mark, CGPA)
...
//(4) traverse
//(5) update
//the element at particular position given by the user.
