...
static struct MOTtable MOT[28] = {{"STOP", 1, "00"}, {"ADD", 1, "01"}, {"SUB", 1, "02"}, {"MULT", 1, "03"}, {"MOVER", 1, "04"}, {"MOVEM", 1, "05"}, {"COMP", 1, "06"}, {"BC", 1, "07"}, {"DIV", 1, "08"}, {"READ", 1, "09"}, {"PRINT", 1, "10"}, {"START", 3, "01"}, {"END", 3, "02"}, {"ORIGN", 3, "03"}, {"EQU", 3, "04"}, {"LTORG", 3, "05"}, {"DS", 2, "01"}, {"DC", 2, "02"}, {"AREG", 4, "01"}, {"BREG", 4, "02"}, {"CREG", 4, "03"}, {"EQ", 5, "01"}, {"LT", 5, "02"}, {"GT", 5, "03"}, {"LE", 5, "04"}, {"GE", 5, "05"}, {"NE", 5, "06"}, {"ANY", 5, "07"}};
...
int nMOT=28;
int LC=0;
int iST=0; //index in symbol table
int iIC=0; //index in intermediate code table
...
void intermediate();
void mcode();
char s1[10],s2[10],s3[10],label[10];
void DC();
void DS();
void START();
int tokencount;
